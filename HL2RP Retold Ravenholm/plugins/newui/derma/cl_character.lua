...
function PANEL:Init()
	...
	-- guides button
	guides = self.buttonList:Add("ixMenuButton")
	guides:SetText("guides")
	guides:SetFont("Font-Elements20")
	guides:SetSize(self.buttonList:GetWide() / 4, self.buttonList:GetTall())
	guides:SetContentAlignment(5)
	guides:Dock(LEFT)
	guides.DoClick = function()
        self:Dim()
        parent.guides:SlideUp()
	end
...
function PANEL:Init()
	...
	-- load guides panel
	self.guides = self:Add("ixCharMenuGuides")
	self.guides:SlideDown(0)
