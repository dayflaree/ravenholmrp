...
ix.loot.containers = {
    ["crate"] = {
        ...
        lootTime = {10}, -- can be a table for random time, example: lootTime = {2, 5, 7, 8, 10},
  ...
  ["vehicle"] = {
    ...
    ["cmb_locker"] = {
        name = "Combine Locker",
        description = "A sturdy storage unit used by the Combine.",
        model = "models/willardnetworks/workshift/workshift-main.mdl",
        skin = 1,
        delay = 180, -- time in seconds before it can be looted again
        lootTime = {10}, -- can be a table for random time, example: lootTime = {2, 5, 7, 8, 10},
        maxItems = {1}, -- how many items can be in the container
