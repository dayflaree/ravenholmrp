...
ix.command.Add("PTLead", {
    ...
    OnRun = function(self, client, target)
        ...
        if (!client:IsCombineCommand()) then
...
ix.command.Add("PTKick", {
    ...
    OnRun = function(self, client, target)
        ...
        if (client.curTeam != target.curTeam and !client:IsCombineCommand()) then return "@TargetNotSameTeam" end

        if (!client.isTeamOwner and !client:IsCombineCommand()) then return "@CannotKickTeamMembers" end
