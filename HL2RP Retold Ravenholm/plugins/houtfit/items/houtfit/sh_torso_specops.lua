ITEM.name = "Spec-Ops Resistance Kevlar"
ITEM.description = "A Resistance uniform in Spec-Ops, it is designed with the best quality materials for the best protection in combat."
