...
ix.command.Add("discord", {
    ...
    OnRun = function(_, ply)
        ply:SendLua([[gui.OpenURL("https://discord.gg/D84K786ybZ")]])
    end
})
...
ix.command.Add("content", {
    ...
    OnRun = function(_, ply)
        ply:SendLua([[gui.OpenURL("https://steamcommunity.com/sharedfiles/filedetails/?id=2836799645")]])
    end
})
...
ix.command.Add("rules", {
    ...
    OnRun = function(_, ply)
        ply:SendLua([[gui.OpenURL("https://docs.google.com/document/d/1t_6vcR2TnFs47iofjQhSPU2liKUeXNhoZvVKV3sxOUU/edit?usp=sharing")]])
    end
})
